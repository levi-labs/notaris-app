    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="myForm" action="{{ route('biaya-tambahan-notaris.store') }}" method="POST">
                            @csrf
                            <input type="hidden" id="notaris_id" name="notaris_id" value="{{ $notaris->id }}">
